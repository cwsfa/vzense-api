...
class VzenseTofCam():
    ...
    def __init__(self):
        if platform.system() == 'Linux':
            libpath = (os.path.abspath(os.path.realpath(__file__) + os.path.sep + "../../../")) + "/Lib/libvzense_api.so"
            print(libpath)
    ...
    def Ps2_SetDataMode(self,  datamode = PsDataMode.PsDepth_30):
